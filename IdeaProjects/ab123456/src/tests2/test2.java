...
public class test2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            System.out.println("InterruptedException from cv1.getValue()!");
        }
        try {
            cv2.getValue();
        } catch (InterruptedException e) {
            System.out.println("InterruptedException from cv2.getValue()!");
        }
        try {
            cv3.getValue();
        } catch (InterruptedException e) {
            System.out.println("InterruptedException from cv3.getValue()!");
        }
        try {
            cv4.getValue();
        } catch (InterruptedException e) {
            System.out.println("InterruptedException from cv4.getValue()!");
        }
        try {
            cv5.getValue();
        } catch (InterruptedException e) {
            System.out.println("InterruptedException from cv5.getValue()!");
        }
        try {
            cv6.getValue();
        } catch (InterruptedException e) {
            System.out.println("InterruptedException from cv6.getValue()!");
        }
